            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="prioritet" class="col-md-4 col-form-label text-md-right">{{ __('Prioritet') }}</label>

                            <div class="col-md-6">
                                <select name="prioritet" id="prioritet" class="custom-select col-md-2">
                        ...
                        <div class="form-group row">
                            <label for="is_active" class="col-md-4 col-form-label text-md-right">{{ __('Aktivan') }}</label>

                            <div class="col-md-6">
                                <label><input id="is_active" type="radio" name="is_active" value="1" checked> Da </label>
                                <label><input id="is_active" type="radio" name="is_active" value="0" > Ne </label>
                            </div>
                        </div>
